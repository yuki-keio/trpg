...
export const ScenarioOptionsModal: React.FC<ScenarioOptionsModalProps> = ({ isOpen, onClose, onGenerate }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
            <div className="bg-gray-800 rounded-lg shadow-xl border border-purple-500/30 w-full max-w-3xl animate-fade-in" onClick={e => e.stopPropagation()}>
                <div className="p-6">
                ...
                <div className="bg-gray-900/50 px-6 py-4 flex flex-col sm:flex-row justify-end gap-4 rounded-b-lg">
