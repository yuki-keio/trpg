            ...
            <div className="bg-gray-800/50 rounded-lg p-4 mb-4">
                ...
                {character.madness?.type && (
                    <div className="mt-3 p-3 bg-red-900/30 border border-red-700/50 rounded-lg">
                        <div className="flex items-center text-red-300 font-bold text-sm mb-1">
                            <BrainCircuit size={14} className="mr-2" />
                            {character.madness.type === 'temporary' ? '一時的狂気' : '不定の狂気'}
                            {character.madness.duration && character.madness.duration > 0 && (
                                <span className="ml-2 text-xs bg-red-800 px-2 py-1 rounded">
                                    {character.madness.duration}ラウンド
                                </span>
                            )}
                        </div>
